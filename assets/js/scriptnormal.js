...
function CalculoFinal() {
	...
	var fullNombres = (document.getElementById("nombre").value + " (" + intHijos + " hijos)").toString();
        (document.getElementById("resultadosnombre").innerHTML += fullNombres),
            ...
            (document.getElementById("totalfinal").innerHTML = "$ " + (calculoVivienda + calculoAlimentacion + calculoEducacion + calculoSalud + calculoVestuario + calculoRecreacion + calculoHigiene + calculoLabores));

        var formState = {};

        (formState._ = (document.getElementById("nombre").value).toString().replace(" ", "%20")),
...
if (urlParams.has("state")) {
    ...
    for (const e of Object.values(camposEnArray))
        "_" == e[0] && (document.getElementById("nombre").value = e.slice(1)),
